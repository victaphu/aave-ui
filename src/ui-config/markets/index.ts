...
export const marketsData: { [key in keyof typeof CustomMarket]: MarketDataType } = {
  ...
  [CustomMarket.proto_harmonyTest]: {
    ...
    addresses: {
      LENDING_POOL_ADDRESS_PROVIDER: '0x66031A3C7281bF338241BFD473033b34b96d8F36'.toLowerCase(),
      LENDING_POOL: '0x05f92877E2761aFCE684b901B98f88b3aE6d2293',
      WETH_GATEWAY: '0x105EF3580D3Ea60841F81185BBA6501c59fe82cF',
    },
  },
} as const;
